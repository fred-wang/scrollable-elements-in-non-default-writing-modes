function scroll_coordinates_behavior() {
    ...
    document.body.insertAdjacentHTML("beforeend", "<div style='direction: rtl; position: fixed; left: 0; top: 0; overflow: hidden; width: 1px; height: 1px;'><div style='width: 2px;'><div style='display: inline-block; width: 1px;'></div><div style='display: inline-block; width: 1px;'></div></div></div>");
